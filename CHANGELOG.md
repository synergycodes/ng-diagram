...
- **The cursor no longer flickers while an edge is drawn or relinked** — the preview edge does not react to the pointer, and the diagram shows the grabbing hand over the canvas for the whole gesture ([#812](https://github.com/synergycodes/ng-diagram/pull/812))
