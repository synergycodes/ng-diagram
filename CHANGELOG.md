...
- `setViewport(x, y, scale)` method on `NgDiagramViewportService` — sets absolute viewport position and scale in a single call, enabling custom-anchor `zoomToFit` implementations ([#653](https://github.com/synergycodes/ng-diagram/pull/653))
