...
import { AngularAdapterCustomEdgeComponent, Edge, IEdgeTemplate, Point } from '@angularflow/angular-adapter';
...
export class CustomBezierEdgeComponent implements IEdgeTemplate {
