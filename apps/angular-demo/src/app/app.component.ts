...
import { UndoRedoModelAdapter } from './undo-redo/undo-redo-model-adapter';
...
@Component({
  ...
  providers: [provideNgDiagram(), UndoRedoService],
...
export class AppComponent {
  ...
  onDiagramInit(event: DiagramInitEvent): void {
    ...
    // Initialize undo-redo service and register middleware
    this.undoRedoService.initialize(this.model);
    this.ngDiagramService.registerMiddleware(this.undoRedoService.getMiddleware());
  ...
  model = new UndoRedoModelAdapter(
    initializeModel({
      nodes: [
        {
          id: '1',
