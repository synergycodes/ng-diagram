...
import { ResizeEdgesNodeComponent } from '../node-template/resize-edges-node/resize-edges-node.component';

export enum NodeTemplateType {
  InputField = 'input-field',
  Image = 'image',
  Resizable = 'resizable',
  ResizeEdges = 'resize-edges',
...
export const nodeTemplateMap = new NgDiagramNodeTemplateMap([
  ...
  [NodeTemplateType.ResizeEdges, ResizeEdgesNodeComponent],
