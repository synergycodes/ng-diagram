...
import { ConditionalNodeComponent } from './conditional-node.component';
...
describe('ConditionalNodeComponent', () => {
  let component: ConditionalNodeComponent;
  let fixture: ComponentFixture<ConditionalNodeComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [FormsModule, ConditionalNodeComponent],
    })
      .overrideComponent(ConditionalNodeComponent, {
        remove: { imports: [AngularAdapterPortComponent] },
        add: { imports: [MockAngularAdapterPortComponent] },
      })
      .compileComponents();

    fixture = TestBed.createComponent(ConditionalNodeComponent);
    component = fixture.componentInstance;
    fixture.componentRef.setInput('data', { id: '1', type: 'conditional', position: { x: 0, y: 0 } });
