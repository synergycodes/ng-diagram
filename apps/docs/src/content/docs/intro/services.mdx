...
<Aside type="tip" title="Waiting for measurements">
  ...
  elements, use the [`waitForMeasurements`](/docs/guides/transactions/#waitformeasurements) transaction option to ensure
  the elements are measured before the viewport adjusts.
</Aside>
