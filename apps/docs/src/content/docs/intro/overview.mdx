...
- **Templates**: Custom visual representations for different node types - Angular component are used as node templates, enabling rich, dynamic content and interaction
