...
- **Customizable Connections**: Customizable edges with various routing options (polyline, curved, orthogonal)
- **Consistent Styling**: Built-in design system with CSS variables and themes for consistent styling across your diagrams. More details can be found in the [Styling](../styling) section
- **Groups**: Containers for other nodes that can be moved together, with automatic sizing based on their contents
...
<LinkCard title="Nodes" href="/internals/nodes/nodes" description="Read more about nodes" />
...
<LinkCard title="Ports" href="/internals/nodes/ports" description="Read more about ports" />
...
<LinkCard title="Edges" href="/internals/edges/edges" description="Read more about edges" />
