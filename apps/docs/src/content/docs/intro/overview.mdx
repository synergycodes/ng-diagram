...
- [`waitForMeasurements`](/docs/api/types/middleware/transactionoptions/#waitformeasurements) option to wait for element dimensions before proceeding (e.g., before calling `zoomToFit()`)
