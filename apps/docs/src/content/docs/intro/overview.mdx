...
<Aside type="caution">
  Use middlewares carefully - poorly implemented middleware can break core functionality and severely impact performance. Always test thoroughly and ensure your middleware properly passes through unhandled operations.
</Aside>

➡️ [Middleware Documentation](/docs/internals/middlewares)
