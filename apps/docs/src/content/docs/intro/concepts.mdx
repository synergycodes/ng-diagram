...
➡️ [Viewport Features](/docs/intro/coordinate-system/#viewport-and-scaling)
...
- **Middleware & Plugins** - Extend diagram behavior with custom logic
...
## Type Safety and Clipboard Support

ngDiagram is fully written in TypeScript, providing type safety and generic templates for compile-time error checking. Clipboard operations (copy, paste) are supported for diagram elements.

- **Type Safety**: Strong typing for models, nodes, edges, and services
- **Clipboard Support**: Copy and paste nodes, edges, and groups
