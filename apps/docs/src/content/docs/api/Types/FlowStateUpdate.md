...
> `optional` **edgesToAdd**: [`Edge`](/docs/api/types/edge/)\<`object`\>[]
...
> `optional` **edgesToUpdate**: `Partial`\<[`Edge`](/docs/api/types/edge/)\<`object`\>\> & `object`[]
...
> `optional` **metadataUpdate**: `Partial`\<[`Metadata`](/docs/api/types/metadata/)\<`object`\>\>
...
> `optional` **nodesToAdd**: [`Node`](/docs/api/types/node/)[]
...
> `optional` **nodesToUpdate**: `Partial`\<[`Node`](/docs/api/types/node/)\> & `object`[]
