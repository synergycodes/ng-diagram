...
> **computePoints**(`routingName`, `context`): [`Point`](/docs/api/types/geometry/point/)[]
...
> **getDefaultRouting**(): [`EdgeRoutingName`](/docs/api/types/routing/edgeroutingname/)
...
> **getRegisteredRoutings**(): [`EdgeRoutingName`](/docs/api/types/routing/edgeroutingname/)[]
