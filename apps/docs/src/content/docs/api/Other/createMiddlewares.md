...
`TMiddlewares` *extends* [`MiddlewareChain`](/docs/api/types/middlewarechain/) = \[[`Middleware`](/docs/api/types/middleware/)\<`string`\>, [`Middleware`](/docs/api/types/middleware/)\<`"z-index"`\>, [`Middleware`](/docs/api/types/middleware/)\<`string`\>, [`Middleware`](/docs/api/types/middleware/)\<`"measured-bounds"`\>, [`Middleware`](/docs/api/types/middleware/)\<`string`\>\]
