...
<CodeSnippet relativePath="edges/edges/minimal-diagram.component.ts" sectionId="adding-edges" />
...
<CodeSnippet relativePath="edges/edges/minimal-diagram.component.ts" sectionId="ports" />
