...
[Custom Edges →](/docs/internals/edges/custom-edges) | [Arrowheads →](/docs/internals/edges/arrowheads)
...
[Routing →](/docs/internals/edges/routing)
...
[Labels →](/docs/internals/edges/labels)
