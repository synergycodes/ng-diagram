...
<CodeSnippet relativePath="edges/routing/diagram.component.ts" />
...
<CodeSnippet relativePath="edges/routing/manual-mode-diagram.component.ts" />
...
<CodeSnippet relativePath="edges/routing/sinusoid-edge.component.ts" />
