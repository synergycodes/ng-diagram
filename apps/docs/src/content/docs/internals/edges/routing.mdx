...
<CodeSnippet relativePath="edges/routing/diagram.component.ts" collapse={['1-47', '37-46']} mark={[55, 65, 75]} />
...
<LinkCard title="Edges Overview" href="/internals/edges/edges" description="General overview of edges in NgDiagram" />
