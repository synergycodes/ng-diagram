...
When adding interactive elements like buttons or inputs to edge labels, dragging on these elements might trigger unwanted diagram behaviors. You can control this using special data attributes:
