...
To display a custom label on an edge, use the `BaseEdgeLabelComponent` in an implementation of a custom edge component:
...
<CodeSnippet relativePath="edges/labels/adding-labels/label-panel.component.ts" />
