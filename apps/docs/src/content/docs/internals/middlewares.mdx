...
For a complete example of creating custom middleware, see the [Custom Middleware example](/examples/custom-middleware/) which demonstrates how to implement a read-only mode middleware that prevents certain operations while allowing others.
