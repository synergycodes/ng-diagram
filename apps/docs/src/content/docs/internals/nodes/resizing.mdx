...
<CodeSnippet relativePath="nodes/resizing/diagram.component.ts" sectionId="enabling" />
...
You can control whether the adornment is enabled either by setting the `value` input property on the adornment component or by setting the `resizable` property on the node data.
