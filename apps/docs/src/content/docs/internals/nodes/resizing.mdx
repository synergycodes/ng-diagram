...
<CodeSnippet relativePath="nodes/resizing/resizing-wrapper.component.ts" sectionId="enabling" />
...
<CodeSnippet relativePath="nodes/resizing/node.component.ts" />
...
<CodeSnippet relativePath="nodes/resizing/resizing-wrapper.component.ts" sectionId="config" />
