...
<CodeSnippet relativePath="nodes/selection/custom/node.component.ts" />

<CodeSnippet relativePath="nodes/selection/custom/node.component.scss" />
...
<CodeSnippet relativePath="nodes/selection/default/node.component.ts" />
