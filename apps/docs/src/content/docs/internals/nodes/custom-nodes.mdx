...
<CodeSnippet relativePath="nodes/custom-node/node.component.ts" />
...
<CodeSnippet relativePath="nodes/custom-node/custom-node-wrapper.component.ts" sectionId="registering" />

After registering, you need to pass the map to the `ngDiagram` component.

<CodeSnippet relativePath="nodes/custom-node/custom-node-wrapper.component.ts" sectionId="usage" />
...
<CodeSnippet relativePath="nodes/custom-node/custom-node-wrapper.component.ts" sectionId="model" />
