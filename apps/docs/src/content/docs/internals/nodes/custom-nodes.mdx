...
<CodeSnippet relativePath="nodes/custom-node/custom-node-wrapper.component.ts" range={[29, 33]} />
...
<CodeSnippet relativePath="nodes/custom-node/custom-node-wrapper.component.ts" range={[40, 48]} mark={[6]} />
