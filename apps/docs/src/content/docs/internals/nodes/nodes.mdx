...
<CodeSnippet relativePath="nodes/nodes/minimal-diagram.component.ts" range={[16, 70]} />
...
import RotatableResizableNode from '@components/angular/nodes/nodes/rotatable-resizable-node/default-node.astro';

<RotatableResizableNode />

<CodeSnippet relativePath="nodes/nodes/rotatable-resizable-node/diagram.component.ts" range={[10, 70]} />

<LinkCard icon="list-format" title="Resizing" href="/docs/nodes/resizing" description="Learn about node resizing" />

<LinkCard icon="list-format" title="Rotation" href="/docs/nodes/rotation" description="Learn about node rotation" />
...
<CodeSnippet relativePath="nodes/nodes/default-node/diagram.component.ts" range={[10, 70]} />
