...
<CodeSnippet relativePath="nodes/rotation/node.component.ts" mark={[11, 13]} collapse={['18-52']} />

## Enabling Rotation for a Node

Enable rotation by setting the `rotatable` property to `true` in your node definition:

<CodeSnippet relativePath="nodes/rotation/rotation-wrapper.component.ts" mark={[52]} collapse={['1-43']} />
...
<CodeSnippet
  relativePath="nodes/rotation/rotation-wrapper.component.ts"
  mark={[{ range: '38-42' }]}
  collapse={['1-35']}
/>
