...
<CodeSnippet relativePath="nodes/rotation/rotation-wrapper.component.ts" sectionId="enabling" />
...
<CodeSnippet relativePath="nodes/rotation/rotation-wrapper.component.ts" sectionId="config" />
