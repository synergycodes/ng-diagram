...
[Registering Custom Types →](/docs/internals/nodes/custom-nodes/#registering-custom-node-types)

## Resizing Custom Group

[Resizing →](/docs/internals/nodes/resizing)
...
[Groups →](/docs/internals/nodes/groups) | [Custom Nodes →](/docs/internals/nodes/custom-nodes)
