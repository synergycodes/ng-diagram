...
[Diagram Configuration →](/docs/internals/nodes/resizing/#configuring-resizing-via-diagram-config)
...
[Selection →](/docs/internals/nodes/selection)
...
[Nodes →](/docs/internals/nodes/nodes) | [Custom Nodes →](/docs/internals/nodes/custom-nodes) | [Resizing →](/docs/internals/nodes/resizing)
