...
- Ports can contain any custom content, such as text, emoji, SVG, or images.
...
- The right port is customized with styles based on a CSS class.
- The bottom port uses a custom SVG as its content and custom styles.
