...
NgDiagram provides a built-in arrowhead called `ng-diagram-arrow` that can be used out of the box. This default arrowhead is an outlined arrow with rounded edges that adapts to the edge's stroke color.
