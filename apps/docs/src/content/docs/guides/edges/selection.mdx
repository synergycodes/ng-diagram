...
More informaction about CSS variables and styling can be found in the [Edges Customization](/docs/guides/edges/edges/#styling-default-edges-with-css-variables) section.
