...
- **[Relinking](/docs/guides/edges/relinking)** — with [`edgeRelinking.enabled`](/docs/api/types/configuration/features/edgerelinkingconfig/#enabled), selected edges show endpoint handles that users can drag to reconnect the edge to another port.
