...
- **[Relinking](/docs/guides/edges/relinking)** — with [`linking.relinkingEnabled`](/docs/api/types/configuration/features/linkingconfig/#relinkingenabled), selected edges show endpoint handles that users can drag to reconnect the edge to another port.
