...
### EdgeRouting Interface

For more control and reusability across different edge types, you can create a custom routing algorithm by implementing the `EdgeRouting` interface. Here's a complete example of an arc routing that uses SVG elliptical arcs to create curved connections:
