...
The diagram adds two Tab stops: the diagram itself and the watermark link.
...
- Your own node templates keep their own Tab stops, so the application stays in control of them.
