...
On touch devices, box selection is triggered by a long press gesture instead of holding `Shift`. Press and hold on the canvas, then drag to create a selection box.
