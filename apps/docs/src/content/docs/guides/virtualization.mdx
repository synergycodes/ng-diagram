...
helpBanner:
  title: Scaling to thousands of nodes?
  body: Even with virtualization enabled, complex node templates or large edge counts can hit a ceiling. Our team can spot the bottlenecks with you, tune the rendering pipeline, and help you ship a smooth experience at that scale.
---
