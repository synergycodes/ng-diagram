...
<Aside type="tip">
  If your resizing configuration seems to be ignored, check for overrides at higher priority levels — node-level settings always take precedence over template or global configurations.
</Aside>
