...
- Supports rotation and resizing (enabled by default through [`resize.defaultResizable`](/docs/api/types/configuration/features/resizeconfig#defaultresizable) and [`nodeRotation.defaultRotatable`](/docs/api/types/configuration/features/noderotationconfig#defaultrotatable) config)
