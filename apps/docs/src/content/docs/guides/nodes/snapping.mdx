...
Snap drag functionality is disabled by default. The default snap step is set to `{ width: 10, height: 10 }`.
...
Snap resize functionality is enabled by default. The default snap step is set to `{ width: 10, height: 10 }`.
