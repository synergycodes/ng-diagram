...
If you don't want to start from scratch, you can use the `NgDiagramBaseNodeTemplateComponent` component as a way to add custom content into the default node.
