...
You can control resizing behavior globally via the [`resize`](/docs/api/types/configuration/features/resizeconfig) config in [`NgDiagramConfig`](/docs/api/types/configuration/ngdiagramconfig), such as setting minimum group size.
