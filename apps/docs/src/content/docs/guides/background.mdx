...
- **Minor cell size**: Size of the smallest grid cell (used for minor grid lines). Controlled via the diagram config [BackgroundConfig.cellSize](/docs/api/types/backgroundconfig/#cellSize)
...
- **Dot spacing**: Controlled via the diagram config [BackgroundConfig.dotSpacing](/docs/api/types/backgroundconfig/#dotSpacing)
