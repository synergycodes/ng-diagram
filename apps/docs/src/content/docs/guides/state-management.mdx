...
Deleting a node also removes the edges connected to it, and deleting a group cascades to all of
its descendants (children, grandchildren, …) — the same semantics as deleting the selection.
