...
Use [`initializeModelAdapter`](/docs/api/utilities/initializemodeladapter) to wire up a custom adapter for use with ngDiagram — it strips stale runtime properties and assigns fresh internal IDs.\
