...
import { getPathPointsFromBottom } from '../utils/pathpoints/get-pathpoints-from-bottom.ts';
import { getPathPointsFromLeft } from '../utils/pathpoints/get-pathpoints-from-left.ts';
import { getPathPointsFromRight } from '../utils/pathpoints/get-pathpoints-from-right.ts';
import { getPathPointsFromTop } from '../utils/pathpoints/get-pathpoints-from-top.ts';
import { getPathPoints } from '../utils/pathpoints/get-pathpoints.ts';
