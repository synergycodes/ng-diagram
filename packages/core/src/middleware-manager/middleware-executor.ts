...
export class MiddlewareExecutor {
  ...
  helpers = () => ({
    ...
    checkNodePropsChange: (props: string[]) => props.some((prop) => this.updatedPropsToNodeIds.has(prop)),
    checkEdgePropsChange: (props: string[]) => props.some((prop) => this.updatedPropsToEdgeIds.has(prop)),
    checkMetadataPropsChange: (props: string[]) => props.some((prop) => this.updatedMetadataProps.has(prop)),
