...
describe('VirtualizedPanningEventHandler', () => {
  const mockCommandHandler = { emit: vi.fn() };
  let mockFlowCore: FlowCore;
  let instance: VirtualizedPanningEventHandler;
  ...
  beforeEach(() => {
    ...
    instance = new VirtualizedPanningEventHandler(mockFlowCore);
  });
  ...
  describe('handle', () => {
    ...
    describe('continue phase', () => {
      ...
      it('should not emit when not panning', () => {
        ...
        const freshInstance = new VirtualizedPanningEventHandler(mockFlowCore);
